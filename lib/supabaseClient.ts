...
export const INITIAL_APP_USERS: AppUser[] = [
  {
    id: 'usr-ceo',
    name: 'عبدالرحمن الكحل (CEO)',
    email: 'ceo@kohlestate-ksa.online',
    phone: '0501112233',
    role: 'CEO',
  ...
  {
    id: 'usr-admin',
    name: 'المدير العام للنظام (Admin)',
    email: 'admin@kohlestate-ksa.online',
    phone: '0509998877',
    role: 'ADMIN',
  ...
  {
    id: 'usr-emp-1',
    name: 'أحمد العتيبي (وسيط عقاري)',
    email: 'ahmed@kohlestate-ksa.online',
    phone: '0551234567',
    role: 'EMPLOYEE',
  ...
  {
    id: 'usr-emp-2',
    name: 'سارة الغامدي (مسؤولة مبيعات)',
    email: 'sara@kohlestate-ksa.online',
    phone: '0567890123',
    role: 'EMPLOYEE',
...
export const INITIAL_EMPLOYEES: Employee[] = [
  {
    ...
    status: 'ACTIVE',
    system_role: 'CEO',
    notes: 'المدير التنفيذي مع كامل الصلاحيات وتفويض المهام والاعتمادات المالية.',
  ...
  },
  {
    ...
    job_title: 'مدير العمليات والتطوير العقاري',
    department: 'إدارة العمليات',
    phone: '0509998877',
    email: 'admin@kohlestate-ksa.online',
    ...
    status: 'ACTIVE',
    system_role: 'ADMIN',
    notes: 'إدارة التقنية والعقود ومتابعة الصفقات والربط مع إيجار وناجز.',
    created_at: `${todayStr}T08:00:00Z`,
  },
  {
    id: 'emp-hr',
    ...
    status: 'ACTIVE',
    system_role: 'HR',
    notes: 'مسؤولة عن التوظيف والرواتب وسجلات الحضور والغياب والإجازات.',
    created_at: `${todayStr}T08:00:00Z`,
  },
  {
    id: 'emp-001',
...
export const INITIAL_LEAVE_REQUESTS: LeaveRequest[] = [
  {
    ...
    status: 'APPROVED',
    approved_by: 'أمل المطيري (HR Manager)',
...
export const INITIAL_TASK_DELEGATIONS: TaskDelegation[] = [
  {
    ...
    description: 'تم تفويض الوسيط أحمد العتيبي لاستكمال توقيع ملحق العقد ومطابقة هوية المستأجر والنيابة في المعاينة.',
    assigned_to_employee_id: 'emp-001',
    assigned_to_name: 'أحمد العتيبي',
    delegated_by_id: 'usr-ceo',
    delegated_by_name: 'عبدالرحمن الكحل (CEO)',
    priority: 'HIGH',
    due_date: '2026-09-20',
    status: 'IN_PROGRESS',
  ...
  },
  {
    ...
    assigned_to_name: 'سارة الغامدي',
    delegated_by_id: 'usr-admin',
    delegated_by_name: 'المدير العام للنظام (Admin)',
    priority: 'MEDIUM',
    due_date: '2026-09-22',
    status: 'PENDING',
